...
Please do not disclose exploitable details, personal information, or secrets in a public issue. Use GitHub's private vulnerability reporting feature if it is enabled for this repository. If that option is unavailable, open a minimal issue asking the maintainer for a private reporting channel without describing the vulnerability.
